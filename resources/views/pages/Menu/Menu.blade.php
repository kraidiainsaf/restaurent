    ...
    @parent
        ...
        <div class="colorlib-menu">
            ...
            function myGeeks() { 
				...
				var text="<form  class='colorlib-form'  method='POST' action='{{ route('Commander') }}'>"+'@csrf <br>'+
				...
				"<input type='text' id='address' name='address' style='background-color: white;border: 1px solid #f38921;padding: 10px;border-radius: 50px 20px;' ></p>"+
				"@endif";
               ...
               number3++;
                ...
                document.getElementById("sudo").innerHTML =text+"<p style='color: black;font-size: small;'>Specification :  <input style='background-color: white;border: 1px solid #f38921;padding: 10px;border-radius: 50px 20px;' type='text' id='specification' name='specification' ></p>"+"<input type='submit' name='submit' class='btn btn-primary' id='submit' value='lancer' class='btn btn-primary btn-block'></form>";
